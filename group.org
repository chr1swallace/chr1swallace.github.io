...
Xin worked on all kinds of next gen sequencing data - pooled DNA, RNA seq, and bisulfite seq - focusing particularly on the extra binomial variation induced by pooling.  She moved to KCL in 2014, and from there to the CTTV project at Sanger/GSK.
...
Niko worked on automated analysis of flow cytometry data and applying clustering methods to call and impute genotypes in the KIR locus.  He moved to UCL in 2014 and maintains notes about his [[http://pontikos.github.io/][current work]].
