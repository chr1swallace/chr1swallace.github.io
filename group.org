...
*** Oliver Burren (PhD student)
#+HTML: <img src="pics/Olly_small.jpg" alt="portrait" style="float:left;margin:0 5px 0 0;" />
Olly Burren is a student in the [[http://www-gene.cimr.cam.ac.uk][Diabetes and Inflammation Laboratory]] supervised by John Todd and Chris Wallace.  He is researching methods to integrate promoter capture Hi-C and GWAS datasets.  In his spare time, he is responsible for the creation and smooth running of the [[http://www.immunobase.org][ImmunoBase]] website which collates data and summary information from GWAS and ImmunoChip analyses of autoimmune diseases.
** Alumni
