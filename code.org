...
*** coloc
    ...
    [[http://cran.r-project.org/web/packages/coloc/index.html][CRAN]] | [[https://github.com/chr1swallace/coloc][github]] | *Note the github repository has important bug fixes that haven't reached CRAN.*
...
* Non-R packages
*** VSEAMS (Olly Burren)
Variant set enrichment analysis (of association summary statistics) using multivariate sampling. Please see the wiki available at http://github.com/ollyburren/vseams/wiki for further details.  Method described in 
{{{vseams}}}
...
Wallace et al. /Am J Hum Genet/ 2006. 79:323-31 [ [[http://europepmc.org/abstract/MED/16826522][Europe PMC]] ] {{{padlock}}}
